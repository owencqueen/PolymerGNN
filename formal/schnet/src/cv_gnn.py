...
from polymerlearn.models.gnn.no_log_models import PolymerGNN_Jointnolog, PolymerGNN_Tgnolog
from polymerlearn.models.gnn.schnet.schnet_pgnn_iv import PolymerGNN_SchNet_IV
...
if args.IV and args.Tg:
    ...
    model_gen = PolymerGNN_SchNet_IV
