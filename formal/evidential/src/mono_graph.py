...
#from polymerlearn.models.gnn.ablation_models import PolymerGNN_IVMono, PolymerGNN_TgMono, PolymerGNN_JointMono
from polymerlearn.models.gnn.iv_evidential import PolymerGNN_IV_evidential as PolymerGNN_IVMono
