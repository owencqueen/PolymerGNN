...
from polymerlearn.models.gnn.ablation_models import PolymerGNN_IV_SP as PolymerGNN_IVMono
from polymerlearn.models.gnn.ablation_models import PolymerGNN_Tg_SP as PolymerGNN_TgMono
from polymerlearn.models.gnn.ablation_models import PolymerGNN_joint_SP as PolymerGNN_JointMono
...
if args.IV and args.Tg:
    ...
    model_gen = PolymerGNN_JointMono

    # Cross validation function (with parameters):
    CV = partial(CV_eval_joint,
        dataset = dataset,
        model_generator = PolymerGNN_JointMono,
